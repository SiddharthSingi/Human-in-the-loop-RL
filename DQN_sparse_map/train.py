...
def main(args):
	...
	num_episodes = 100000	# Number of episodes to train on
	ep_decay_in = 40000	# Epsilon will decay from eps_start to eps_end in ep_decay_in episodes
	eps_start = 0.7
	eps_end = 0.05
	lr = 5e-5			# Learning rate for Q, M models
	lr_v = 5e-5			# Learning rate for V model
	burn_in = 300		# Number of episodes added to replay memory on suniform policy at initiialization
	...
	DQN.offline_training(1000000, 1000000, smoothing_number=250, target_freq=1000)
